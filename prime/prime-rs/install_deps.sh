#!/usr/bin/env bash
# install_deps.sh — install dependencies for prime-rs
#
# Installs:
#   Rust — rustup toolchain + cargo-tarpaulin (build, test, coverage)
#
# No external C libraries required (unlike pi-rs).
#
# Supported platforms:
...
echo "=== prime-rs dependency installer ==="
echo ""
...
echo ""
echo "  make prime — build release binary"
