...
#
# Ported verbatim from dotfiles/scripts/bash-tracer.sh @ c27cc4e (dotfiles
# master, 2026-08-09) — no divergence. Per-repo copy is deliberate; see the
# header of scripts/run-bash-coverage.sh for why.
